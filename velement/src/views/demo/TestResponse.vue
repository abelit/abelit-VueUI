<template>
  <div>
    <el-row :gutter="10">
      <el-col :span="24" :md="12" style="margin-top: 10px">
...
export default {
  ...
  methods: {
    ...
    test() {
      ...
      //   ];
      //   console.log(newarr.filter(item => item.flag in ['aa']))
      ...
      let filterList = ["aa", "bb"];
      let result = newarr.filter(item => !filterList.includes(item.flag));
      console.log(result);
    }
  },
  mounted() {
